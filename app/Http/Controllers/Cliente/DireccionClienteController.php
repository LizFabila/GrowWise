...
class DireccionClienteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('cliente.direcciones.index')->with('success', 'Dirección agregada correctamente');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('cliente.direcciones.index')->with('success', 'Dirección actualizada correctamente');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('cliente.direcciones.index')->with('success', 'Dirección eliminada correctamente');
    }
