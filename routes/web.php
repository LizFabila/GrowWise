...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['role:vendedor,admin'])->group(function () {
        ...
        Route::get('/cosechas/{cosecha}/edit', [CosechaController::class, 'edit'])->name('cosechas.edit');
        ...
        Route::prefix('reportes')->name('reportes.')->group(function () {
            ...
            Route::get('/generar/{cultivo?}', [ReporteController::class, 'generar'])->name('generar');
            Route::get('/{id}/descargar', [ReporteController::class, 'descargar'])->name('descargar');
            Route::get('/{id}/ver', [ReporteController::class, 'ver'])->name('ver'); // ← NUEVA RUTA
            Route::delete('/{id}/eliminar', [ReporteController::class, 'eliminar'])->name('eliminar');
        });
        ...
        // ===========================================
        // MÓDULO DE VENTAS PARA VENDEDORES (AGREGADO AQUÍ)
        // ===========================================
